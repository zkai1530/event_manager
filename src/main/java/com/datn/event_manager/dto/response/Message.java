...
public class Message {
    ...
    public static final String LOGOUT_SUCCESS = "Log out successfully!";
    ...
    public static final String ADD_CATE_AND_THEME_SUCCESS = "Add category and theme was successfully!";
