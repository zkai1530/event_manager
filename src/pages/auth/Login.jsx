      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center">
        <div className="flex flex-col rounded-lg border border-slate-400 bg-gray-900/10 p-8 shadow-lg backdrop-blur-md backdrop-filter">
          ...
          <p className="mb-6 text-slate-300">
            Access your account and manage events easily. Join us?
          </p>
          ...
          <button
            ...
            type="button"
          >
            <div className="bg-main-bold absolute top-[4px] left-1 z-10 flex h-9 w-1/4 items-center justify-center rounded-md duration-500 group-hover:w-[384px]">
              <FaArrowRight />
            </div>
